import { View, FlatList, StyleSheet, TouchableOpacity, Text, Animated, Modal } from "react-native";
...
const DATA = [
	{
		title: "На следующий день у вас нет запланированных занятий и вы можете позволить себе спать столько, сколько захочется. Когда вы проснетесь?",
		id: "1",
		quethion: [
		...
		>
			<View style={taskListStyles.modalView}>
				<View style={[taskListStyles.formContainer, gStyles.boxShadowMain]}>
					<Text style={taskListStyles.formTitle}>Ваш хронотип это {result}</Text>
